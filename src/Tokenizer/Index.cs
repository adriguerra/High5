...
using neTree = ParseFive.Tokenizer.NamedEntityData.neTree;
...
namespace ParseFive.Tokenizer
{
    static class Index
    {
        ...
        public static char toChar(int cp) //TODO consider if cp can be typed as uint
        {
            ...
            cp -= 0x10000;
            return String.fromCharCode(cp >>> 10 & 0x3FF | 0xD800) + String.fromCharCode(0xDC00 | cp & 0x3FF); //TODO >>>
        }
